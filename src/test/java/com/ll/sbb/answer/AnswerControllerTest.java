...
public class AnswerControllerTest {
    ...
    void test1() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/answer/create/{id}",questionId).param("content",content))
                .andExpect(MockMvcResultMatchers.status().is3xxRedirection())
                .andExpect(MockMvcResultMatchers.redirectedUrl(String.format("/question/detail/%s",questionId)));

        verify(answerService,times(1)).create(any(Question.class),eq(content));
